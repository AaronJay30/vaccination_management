<?php
    ...
    if(isset($_POST['reset'])){
        ...
        if($code != $vcode){
            ...
            $enpass = md5($npass);
            $sql = "UPDATE user_login SET password = '$enpass' WHERE email = '$email'";
    ...
    <div class="container">
        <div class="forms">
            <div class="form login">
                ...
                <div class="login-reg">
                    <span class="text">Register Account? 
                        <a href="student_signup.php" class="text signup-link">Sign up</a>
                    </span>
                </div>

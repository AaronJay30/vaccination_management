    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-2 pt-5 pb-4" style="background: #fff;">
                ...
                <button type="submit" name="btn_pdf" class="btn btn-success form-control mt-3 mb-3 report_btn">Generate Report</button>
                ...
                <ul class="list-group">
                    <?php
                        $sql = "SELECT DISTINCT gender FROM user_login WHERE user_login_id IN (SELECT userid FROM user_vaccine) 
                        ORDER BY gender";
                ...
                <ul class="list-group">
                    <?php
                        $sql = "SELECT DISTINCT roles FROM user_login WHERE user_login_id IN (SELECT userid FROM user_vaccine) 
                        ORDER BY roles";
                        $result = mysqli_query($conn,$sql);
                ...
                <ul class="list-group">
                    <?php
                        $sql = "SELECT DISTINCT address FROM user_login WHERE user_login_id IN (SELECT userid FROM user_vaccine) 
                        ORDER BY address";
                        $result = mysqli_query($conn,$sql);
                ...
                <ul class="list-group">
                    <?php
                        $sql = "SELECT DISTINCT grade FROM user_login WHERE user_login_id IN (SELECT userid FROM user_vaccine) 
                        ORDER BY grade";
                        $result = mysqli_query($conn,$sql);
                ...
                <ul class="list-group">
                    <?php
                        $sql = "SELECT DISTINCT section FROM user_login WHERE user_login_id IN (SELECT userid FROM user_vaccine) 
                        ORDER BY section";
                        $result = mysqli_query($conn,$sql);
                ...
                <ul class="list-group">
                    <?php
                        $sql = "SELECT DISTINCT department FROM user_login WHERE user_login_id IN (SELECT userid FROM user_vaccine) 
                        ORDER BY department";
                        $result = mysqli_query($conn,$sql);
                        ...
                        if(isset($_GET['status'])){
                            if($_GET['action'] == "update"){
                                ...
                                if($_GET['status'] == "success"){ ?>
                                    ...
                                    <div class="alert alert-success alert-dismissible fade show" role="alert" style="color: #007820; background-color: #8af3a6; border-color: #0ee948;">
                                        <strong>You've succesfully archive data!</strong>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                ...
                                <?php } else { ?>
                                    ...
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                        <strong>Error archiving!</strong> Please try again
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                ...
                                if($_GET['status'] == "success"){ ?>
                                    ...
                                    <div class="alert alert-success alert-dismissible fade show" role="alert" style="color: #007820; background-color: #8af3a6; border-color: #0ee948;">
                                        <strong>You've succesfully change your password!</strong>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                ...
                                <?php } else if($_GET['errorid'] == 3){?>
                                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                            <strong>Error!</strong> Password should have atleast 8 characters
                                            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                    ...
                    <table class="table table-striped text-center" id="myTable">
                        ...
                        <tbody class="expand" id="result">
                            <?php
                                ...
                                $sql = "SELECT * FROM user_vaccine INNER JOIN user_login ON user_vaccine.userid = user_login.user_login_id";
                                $result = mysqli_query($conn, $sql);
                                
                                if($result){
                                    while($row = mysqli_fetch_assoc($result)){
                                        $id = $row["user_vaccine_id"];
                                        $userid = $row["userid"];
                                        $name = $row["name"];
                                        $gender = $row["gender"];
                                        ...
                                        echo '
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-primary"><a href="update_admin.php?uid='.$userid.'" target="_blank" class="text-light">Update</a></button>
                                                    <button class="btn btn-danger"><a href="admin_archive.php?archiveid='.$userid.'" class="text-light">Archive</a></button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $(".report_btn").click(function(){
                ...
                if (typeof(filteredCheck) != 'undefined'){
                    var checkArray = filteredCheck;
                } else {
                    var checkArray = [];
                }

                if (typeof(filteredDate) != 'undefined'){
                    var dateArray= filteredDate;
                } else {
                    var dateArray = [];
                }
                ...
                var src = "generate-report.php?fltrCheck="+checkArray+"&fltrDate="+dateArray+"&numData="+rowCount;
            ...
            $(".filter_check").click(function(){
                ...
                for (var i = 0; i < checkboxes.length; i++) {
                    filteredCheck.push(checkboxes[i].value)
                }
            ...
            $(".btn_filter").click(function(){
                    ...
                    filteredDate.push(start_date);
                    filteredDate.push(end_date);
